...
convert from the wide to the long format. The `tidyr` function `pivot_longer()` will
'lengthen' your observation variables into a single variable.
...
pivoted into wider format. We could type out all the observation variables, but
...
identify which variables are not to be gathered (i.e. ID variables).
...
Classes 'tbl_df', 'tbl' and 'data.frame':	5112 obs. of  4 variables:
 $ continent   : chr  "Africa" "Africa" "Africa" "Africa" ...
 $ country     : chr  "Algeria" "Algeria" "Algeria" "Algeria" ...
 $ obstype_year: chr  "gdpPercap_1952" "gdpPercap_1957" "gdpPercap_1962" "gdpPercap_1967" ...
 $ obs_values  : num  2449 3014 2551 3247 4183 ...
~~~
{: .output}
...
It is always good to check work. So, let's use the opposite of `pivot_longer()` to
'widen' our observation variables back out with the aptly named `pivot_wider()`. We
...
To `names_from` we supply the column name whose contents will be spread into new
...
~~~
Classes 'tbl_df', 'tbl' and 'data.frame':	5112 obs. of  4 variables:
 $ var_ID    : chr  "Africa_Algeria" "Africa_Algeria" "Africa_Algeria" "Africa_Algeria" ...
...
~~~
Classes 'tbl_df', 'tbl' and 'data.frame':	5112 obs. of  3 variables:
 $ ID_var    : chr  "Africa_Algeria" "Africa_Algeria" "Africa_Algeria" "Africa_Algeria" ...
 $ var_names : chr  "gdpPercap_1952" "gdpPercap_1957" "gdpPercap_1962" "gdpPercap_1967" ...
 $ obs_values: num  2449 3014 2551 3247 4183 ...
~~~
{: .output}
...
~~~
Classes 'tbl_df', 'tbl' and 'data.frame':	142 obs. of  37 variables:
